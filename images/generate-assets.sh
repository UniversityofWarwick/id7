...
./svg-to-png.sh src/masthead-logo-bleed-sm@2x.svg 2340 600 masthead-logo-bleed-sm@2x.png
./svg-to-png.sh src/masthead-logo-bleed-sm.svg 1170 300 masthead-logo-bleed-sm.png

./svg-to-png.sh src/masthead-logo-bleed-xs@2x.svg 3360 600 masthead-logo-bleed-xs@2x.png
./svg-to-png.sh src/masthead-logo-bleed-xs.svg 1680 300 masthead-logo-bleed-xs.png

./svg-to-png.sh src/masthead-logo-bleed-wide-xs@2x.svg 3360 600 masthead-logo-bleed-wide-xs@2x.png
./svg-to-png.sh src/masthead-logo-bleed-wide-xs.svg 1680 300 masthead-logo-bleed-wide-xs.png
./svg-to-png.sh src/masthead-logo-bleed-wide-sm@2x.svg 1984 160 masthead-logo-bleed-wide-sm@2x.png
./svg-to-png.sh src/masthead-logo-bleed-wide-sm.svg 992 80 masthead-logo-bleed-wide-sm.png
./svg-to-png.sh src/masthead-logo-bleed-wide-md@2x.svg 2400 160 masthead-logo-bleed-wide-md@2x.png
./svg-to-png.sh src/masthead-logo-bleed-wide-md.svg 1200 80 masthead-logo-bleed-wide-md.png
./svg-to-png.sh src/masthead-logo-bleed-wide-lg@2x.svg 6000 160 masthead-logo-bleed-wide-lg@2x.png true 450
